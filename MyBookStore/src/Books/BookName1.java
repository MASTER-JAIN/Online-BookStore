...
/**
 * Servlet implementation class BookName1
 */
@WebServlet("/BookName1")
public class BookName1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String aut = request.getParameter("BookName");
        ...
        PreparedStatement ps = con.prepareStatement("select BooksId,Author,BookName,NoCopies,Price,Catogary,Genre from Books where BookName like '"+aut+"%'");
...
request.setAttribute("book",b);
        ...
        RequestDispatcher rsp =request.getRequestDispatcher("BookName1.jsp");
