...
<% 
			...
			user u=(user)sess.getAttribute("use");//this will return username anytime in the session
			...
			<div class="products">
				...
				<ul>
				        ...
				        <% 
				            ...
				            ResultSet resultset = 
				                statement.executeQuery("select BooksId,Author,BookName,NoCopies,Price from Books where Catogary='Fiction'") ; 
				        %>
